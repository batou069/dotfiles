...
alias of='fd .md $HOME/Obsidian/ | sed "s|$HOME/Obsidian/||" | fzf --preview "bat $HOME/Obsidian/{1}" --preview-window "50%:wrap" --border-label="Obsidian Files" --bind "enter:become(nvim $HOME/Obsidian/{1})"'
# alias rgf='rg --line-number --no-heading . | fzf --delimiter : --preview "bat  {1} --highlight-line {2}" --preview-window "70%:wrap" --border-label="Ripgrep Files" --bind "enter:become(nvim {1} +{2})"'

alias fkill='~/scripts/fkill.sh'
# alias v="fzf --preview --border-label='File Picker' 'bat {}' --preview-window '70%:wrap' --multi --bind 'enter:become(nvim {+})'"
# alias v="fzf --preview --border-label='Open in Vim' 'bat {}' --preview-window '70%:wrap' --multi --bind 'enter:become(vim {+})'"
# alias mans='man -k . | fzf --border-label="Man Pages" | awk "{print \$1}" | xargs -r man'
# alias ns="nix-search-tv print | fzf --preview 'nix-search-tv preview {}' --preview-window '70%:wrap' --multi --bind --scheme history"
...
#   local previewer_cmd="bat  --highlight-line {2} {1}"
